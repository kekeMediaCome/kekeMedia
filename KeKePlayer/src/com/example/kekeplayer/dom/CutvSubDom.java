package com.example.kekeplayer.dom;
...
public class CutvSubDom {
	public static List<CutvLiveSub> parseXml(String url) {
		List<CutvLiveSub> cutvList = new ArrayList<CutvLiveSub>();
		...
		try {
			...
			for (int i = 0; i < nodeListcount; i++) {
				...
				// 新建一个channel对象
				CutvLiveSub cutvLiveSub = new CutvLiveSub();
				// 取得tv标签的下属所有节点
